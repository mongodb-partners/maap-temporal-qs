...
# Variables
INFRA_STACK_NAME="MAAP-Temporal-Stack-Infrastructure"
EC2_STACK_NAME="MAAP-Temporal-Stack-Compute"
...
MongoDBClusterName="MongoDBTemporalV1"
MongoDBUserName="*******"
MongoDBPassword="*******"
APIPUBLICKEY="*******"
APIPRIVATEKEY="*******"
...
LLM_MODEL_ID="us.anthropic.claude-3-7-sonnet-20250219-v1:0" #LLM Model ID
EMBEDDING_MODEL_ID="amazon.titan-embed-text-v1" #Embedding Model ID
...
{
  # Parameters
  KEY_NAME="MAAPTemporalKeyV1"  # You can change the key pair name as desired.
